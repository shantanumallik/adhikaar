    ...
    <div id="index-banner" class="parallax-container">
        ...
        <div class="parallax"><img src="images/flag.jpg" alt="Unsplashed background img 1" /></div>
            ...
            <div class="row">
                ...
                <asp:TextBox ID="def" style="display: none;" runat="server"></asp:TextBox>
                <input type='hidden' id=quality  value="100"/>
            </div>
            <div class="row center">
                <div class="col s4 offset-s4">
                                   
                    <asp:LinkButton ID="LinkButton1" runat="server" CssClass="btn btn-large waves-effect waves-light orange lighten-1 hoverable" OnClientClick="return true" OnClick="LinkButton1_Click">Confirm Aadhaar Number</asp:LinkButton>
        ...
        <div class="row center">
         <div class="col s4 offset-s4"> 
             ...
             <asp:TextBox ID="phn"  runat="server"></asp:TextBox>
                    ...
                    <asp:LinkButton ID="LinkButton3" runat="server" CssClass="btn btn-large waves-effect waves-light orange lighten-1 hoverable" OnClick="LinkButton3_Click">Send OTP</asp:LinkButton>
        ...
        <div class="row center">
         ...
         <div class="col s4 offset-s4"> 
             <asp:TextBox ID="otp"  runat="server"></asp:TextBox>
                    ...
                    <asp:LinkButton ID="LinkButton4" runat="server" CssClass="btn btn-large waves-effect waves-light orange lighten-1 hoverable" OnClick="LinkButton4_Click">Verify OTP</asp:LinkButton>
                    </div>
