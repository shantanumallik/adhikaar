...
<head runat="server">
    ...
    <title>Adhikaar - Add Candidates</title>
...
<body>
    ...
    <div class="container">
        <div class="row input-field">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=CODEROOM\ADHIKAAR;Initial Catalog=AdhikaarDB;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [title] FROM [elections]"></asp:SqlDataSource>
            <br />
        ...
        <div class="row">
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="Data Source=CODEROOM\ADHIKAAR;Initial Catalog=AdhikaarDB;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [cid] FROM [candidates] WHERE ([ename] = @ename)">
                <SelectParameters>
