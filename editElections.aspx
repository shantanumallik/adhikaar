    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            <Columns>
                ...
                <asp:BoundField DataField="starttime" HeaderText="Start" SortExpression="starttime" DataFormatString = "{0:dd/MM/yyyy hh:mm:ss tt}" />
                <asp:BoundField DataField="endtime" HeaderText="End" SortExpression="endtime"  DataFormatString = "{0:dd/MM/yyyy hh:mm:ss tt}"/>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=CODEROOM\ADHIKAAR;Initial Catalog=AdhikaarDB;Integrated Security=True" ProviderName="System.Data.SqlClient" 
            SelectCommand="SELECT [id], [title], [starttime], [endtime], [descriptionelection], [constituency] FROM [elections]"
            UpdateCommand = "UPDATE elections SET title = @title, starttime = @starttime, endtime = @endtime, descriptionelection = @descriptionelection, constituency = @constituency where id = @id"
            DeleteCommand ="DELETE from elections where id = @id">

            <UpdateParameters>
                <asp:Parameter Name="title"/>
                <asp:Parameter Name="constituency"/>
                <asp:Parameter DbType="DateTime" Name="starttime"/>
                <asp:Parameter DbType="DateTime" Name="endtime"/>
