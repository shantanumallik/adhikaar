...
<head runat="server">
    ...
    <title>Adhikaar - Elections</title>
...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=CODEROOM\ADHIKAAR;Initial Catalog=AdhikaarDB;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [elections]"></asp:SqlDataSource>
        </div>
    </div>
       </form>
